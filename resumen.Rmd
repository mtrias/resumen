...
# Configurar el directorio de trabajo al directorio del script que se ejecuta en RStudio
setwd( dirname(rstudioapi::getSourceEditorContext()$path) )
```

## RStudio

| Atajos de Teclado de RStudio sarasa               |            | ⊞           |
|:--------------------------------------------|:------------|:------------|
...
```{r}
murders |> arrange(desc(rate), population) |> head()
```
...
# Importando Datos ([Cap 5](https://rafalab.dfci.harvard.edu/dslibro/importing-data.html))
