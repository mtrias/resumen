...
```{r echo=FALSE, warning=FALSE, include=FALSE, error=FALSE}
library("dplyr")
library("dslabs")
data('murders')
data('heights')
...
# Graficos Basicos
[cap 2.15](https://rafalab.dfci.harvard.edu/dslibro/r-basics.html#gráficos-básicos)
...
[cap 3](https://rafalab.dfci.harvard.edu/dslibro/conceptos-básicos-de-programación)
...
# TidyVerse
[cap 4](https://rafalab.dfci.harvard.edu/dslibro/tidiverse.html)
...
# Importando Datos
[Cap 5](https://rafalab.dfci.harvard.edu/dslibro/importing-data.html)
...
# dplyr::ggplot2
[Cap 7](https://rafalab.dfci.harvard.edu/dslibro/ggplot2.html)
